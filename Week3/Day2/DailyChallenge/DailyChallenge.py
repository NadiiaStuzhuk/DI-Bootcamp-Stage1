...
print("--- Initial Visible Items (Page 1) ---")
print(p.get_visible_items())

print("\n--- Moving to Next Page (Page 2) ---")
p.next_page()
print(p.get_visible_items()) 

print("\n--- Moving to Last Page (Page 7) ---")
p.last_page()
print(p.get_visible_items()) 

print("\n--- Testing Magic String Method (on Last Page) ---")
print(str(p))
...
p.first_page()
chained_output = p.next_page().next_page().next_page().get_visible_items()
print(chained_output)  # Expected: ['m', 'n', 'o', 'p']

print("\n--- Testing ValueError Exception Handling ---")
try:
    p.go_to_page(10)
