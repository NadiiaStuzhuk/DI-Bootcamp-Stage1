...
print(f"Zara targets various clients by offering clothes for: {clients}.")
...
# Using a dictionary comprehension with enumerate()
...
# Flipping the key-value roles using enumerate()
disney_users_B = {index: character for index, character in enumerate(users)}
print("Result 2:")
print(disney_users_B)
print("-" * 40)

# 3. Sort characters alphabetically first, then map to new indices
sorted_users = sorted(users)
disney_users_C = {character: index for index, character in enumerate(sorted_users)}
print("Result 3:")
