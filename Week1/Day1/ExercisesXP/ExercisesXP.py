...
#3 == 3                True
#3 == "3"              False
#"3" > 3              Should be an error, because ">" is not supported between instances of 'str' and 'int;
#"Hello" == "hello"   False
print("Here is the output of the code snippets: ")
print("5 < 3: " + str(5 < 3))
print("3 == 3: " + str(3 == 3))
print("3 == \"3\": " + str(3 == "3"))
...
if name == "Nadiia":
    ...
    print("Nice to meet you, " + name + "! Your namme makes such a difference!")
